...
class ClipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clip" do
    assert_difference("Clip.count") do
      post clips_url, params: { clip: { description: @clip.description, title: @clip.title, user_id: @clip.user_id } }
    end
  ...
  test "should update clip" do
    patch clip_url(@clip), params: { clip: { description: @clip.description, title: @clip.title, user_id: @clip.user_id } }
